...
Alle felt som kan brukes i POST for oppretting av nytt objekt er med i
strukturen. De feltene som ikke kan forhåndsutfylles automatisk og som
ikke må fylles ut manuelt har verdien «null» for enkeltverdier og «[]»
for lister for å synliggjøre dette. Felter som må ha manuelt satt
